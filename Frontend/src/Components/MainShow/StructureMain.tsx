  ...
  return (
    <>
      <div className="flex flex-col justify-center pl-9 relative ">
        ...
        <div className="absolute right-2 top-8 sm:top-28 sm:right-5 w-72 text-xl font-bold tracking-wide mr-7 font-yekan text-zinc-700 dark:text-white lg:w-auto lg:hidden">
          <LiveClock />
        </div>
