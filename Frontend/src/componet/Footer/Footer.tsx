  ...
  return (
    <footer className="bg-gradient-to-r from-blue-900 to-purple-900 text-white p-8  bottom-0 left-0 w-full ">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start font-yekan">
        ...
        {/* Other Languages and Social Media Links */}
        <div className="flex flex-col items-center md:items-start">
          ...
          <h4 className="text-lg font-bold mb-4">دنبال کردن ما</h4>
          ...
          <div className="flex space-x-4 space-x-reverse">
            ...
            {/* Aparat" */}
            <Link
              to="https://www.aparat.com/qommetropolis"
              aria-label={""}
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-gray-500"
            ...
            {/* instagram */}
            <Link
              to="https://instagram.com/shahrdary_qom"
              aria-label={""}
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* "Eita" */}
            <Link
              to="https://eitaa.com/shahrdari_qom"
              aria-label={""}
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-gray-500"
      ...
      <div className="container mx-auto mt-8 text-center text-sm">
        <p>© کلیه حقوق مادی و معنوی محفوظ و متعلق به شهرداری قم می‌باشد.</p>
      </div>
    </footer>
  );
};
